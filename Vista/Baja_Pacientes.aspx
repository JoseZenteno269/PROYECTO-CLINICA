<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Baja_Pacientes.aspx.cs" Inherits="Vista.Baja_Pacientes" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="grupo-pacientes" align="center">
            <br />
            <asp:GridView ID="gvPacientes" runat="server" AutoGenerateColumns="False" CssClass="gv" GridLines="None" BorderStyle="None" BorderWidth="0px" CellPadding="0" AllowPaging="True" OnPageIndexChanging="gvPacientes_PageIndexChanging">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Fecha de Nacimiento">
                        <ItemTemplate>
                            <asp:Label ID="lbl_it_Fecha" runat="server" Text='<%# Bind("FechaNacimiento_Paci", "{0:d}") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
